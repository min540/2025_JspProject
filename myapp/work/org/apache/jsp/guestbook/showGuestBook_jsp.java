 ...
 * Generated at: 2025-03-18 03:43:22 UTC
...
public final class showGuestBook_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/guestbook/postGuestBook.jsp", Long.valueOf(1742182851207L));
  }
...
if (id == null) {
	...
	response.sendRedirect("login.jsp?url=" + url);
      ...
      out.write("	}\r\n");
      out.write("	\r\n");
      out.write("	function cdelFn(cnum){\r\n");
      ...
      out.write("</td>\r\n");
      out.write("							<td>\r\n");
      out.write("								<!-- 본인 : 수정, 삭제. 관리자 : 삭제, 비밀글 여부 --> ");
 ...
 if (chk || login.getGrade().equals("1") /*관리자*/) {
 	if (chk) {
      ...
      out.write(' ');
      out.print(bean.getSecret().equals("1") ? "비밀글" : "");
      out.write("\r\n");
      out.write("							</td>\r\n");
      out.write("						</tr>\r\n");
      out.write("					</table>\r\n");
      ...
      out.write("									<!-- 로그인과 댓글 글쓴이가 같거나 또는 관리자라면 -->\r\n");
      out.write("									");
 
										boolean chk2 = login.getId().equals(cbean.getCid());
										if(chk2||login.getGrade().equals("1")){ 
      out.write("\r\n");
      out.write("											<a href=\"#\" onclick=\"javascript:cdelFn('");
      ...
      out.write("						onclick=\"commentFn(this.form)\"> <input type=\"hidden\"\r\n");
      out.write("						name=\"flag\" value=\"insert\"> <!-- 방명록 글번호 --> <input\r\n");
