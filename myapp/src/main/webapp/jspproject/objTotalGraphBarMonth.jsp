...
<div class="bar-container2">
            ...
            <div class="graph-card2">
			    <div class="graph-double">
				    <div class="graph-card">
				        <div class="graph-box">
				            <canvas id="goalChartMonth"></canvas>
				            <div class="graph-label">이번 달 목표 달성 건수</div>
				        </div>
				    </div>
				    
				    <div class="graph-card">
				        <div class="graph-box">
				            <canvas id="memoChartMonth"></canvas>
				            <div class="graph-label">이번 달 일지 작성 건수</div>
				        </div>
				    </div>
				</div>
			</div>
    ...
    <div class="bottom-text">이번 달 작성한 일지 수 : 0개</div>
</div>
