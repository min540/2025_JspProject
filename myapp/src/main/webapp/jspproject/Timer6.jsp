...
<div class="timer6-timer-container" id="timerContainer"
     style="left:<%= left %>px; top:<%= top %>px; <%= extraStyle %>">
  <div class="timer6-drag-handle">:::</div>

  <svg class="timer6-svg" width="240" height="240">
    <circle cx="120" cy="120" r="100" stroke="#333" stroke-width="12" fill="none" />
    <circle id="progress" cx="120" cy="120" r="100" stroke="#0B2161" stroke-width="12" fill="none"
      stroke-linecap="butt" stroke-dasharray="628" />
  </svg>

  <div class="timer6-center">
    <div class="timer6-time" id="timeDisplay">00:00</div>
    <div class="timer6-info" id="timerInfo">
      <strong id="sessionTime">00:00</strong> 세션<br>
      과 <strong id="breakTime">00:00</strong> 휴식
    </div>
  </div>

  <div class="timer6-bottom-controls">
    <button class="timer6-btn" id="btnReset">⟲</button>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const dragHandle = document.querySelector(".timer6-drag-handle");
  ...
  const updateProgress = () => {
    ...
    progressCircle.style.stroke = isSession ? "#0B2161" : "#FFFF00";
