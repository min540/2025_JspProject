...
<%
    ...
    TemaBean tema = temaMgr.getOnTema(userId);

    // Null 예외 방지: tema 또는 tema.getTema_img()가 null일 경우 기본값으로 대체
    String imgName = (tema != null && tema.getTema_img() != null) ? tema.getTema_img() : "tema1.jpg";
